...
import DirectoryUploadMenuItem from "@/Components/app/DirectoryUploadMenuItem.vue";
...
<template>
    <Menu as="div" class="relative block text-left">
        <MenuButton
            class="flex w-full justify-center gap-x-1.5 rounded-md bg-white px-3 py-2 texts-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
        >
            Create New
        </MenuButton>
